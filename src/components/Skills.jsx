  ...
  return (
    <section id="skills" className="bg-white dark:bg-gray-900 py-20 px-[10rem] flex flex-col md:flex-row">
      <div className="container">
        <h2 className="text-4xl mb-4 font-bold ml-[2rem] dark:text-purple-300 text-purple-500">
          Skills, Tools & Technology
        </h2>
        {/* Adjust grid layout for mobile and keep desktop as is */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 justify-items-center mt-6">
